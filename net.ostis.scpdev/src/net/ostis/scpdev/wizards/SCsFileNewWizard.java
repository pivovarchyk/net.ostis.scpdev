 ...
 */
public class SCsFileNewWizard extends AbstractScFileNewWizard {

    private class SCsFileNewWizardPage extends AbstractScFileNewWizardPage {

        public SCsFileNewWizardPage(IStructuredSelection selection) {
            super("New SCs Source File Wizard", selection);
            setTitle("New SCs Source File");
            setDescription("This wizard creates a new SCs source file.");
        }
    ...
    protected AbstractScFileNewWizardPage createFilePage() {
        return new SCsFileNewWizardPage(selection);
    }
