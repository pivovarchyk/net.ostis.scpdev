 ...
 * <li>serialization support (the model hierarchy must be serializable, so that the editor can save
 * and restore a binary representation. You might not need this, if you store the model a non-binary
 * form like XML).</li>
 * </ul>
 *
